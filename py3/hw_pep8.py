...
class Calculator:
    ...
    def add_record(self, record):  # To record data from calculator
        self.records.append(record)

    def get_today_stats(self):  # How much money/calories spent today
        spent = 0
        today = dt.date.today()
    ...
    def get_week_stats(self):  # How much money/calories spent for a week
        spent_in_week = 0
